...
def train():
    ...
    results = model.train(data=str(Path(__file__).parent.resolve() / 'TFG_pose_640_v5' / 'data.yaml'), epochs=100, imgsz=640, project=str(Path(__file__).parent.resolve() / 'runs' ))
