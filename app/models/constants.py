...
class RobotCte():
    ...
    POSE_PUZZLE_SQUARE_5 = np.array([-0.433, -0.067, SAFE_Z, ROTATION[0], ROTATION[1], ROTATION[2]])
    POSE_PUZZLE_HEXAGON_5 = np.array([-0.4335, -0.0185, SAFE_Z, ROTATION[0], ROTATION[1], ROTATION[2]])
    POSE_PUZZLE_CIRCLE_5 = np.array([-0.433, -0.1168, SAFE_Z, ROTATION[0], ROTATION[1], ROTATION[2]])
    # 10%
    ...
    # 15%   
    POSE_PUZZLE_SQUARE_15 = np.array([-0.337, -0.068, SAFE_Z, ROTATION[0], ROTATION[1], ROTATION[2]])
