...
# nnPathDefault = str((Path(__file__).parent / Path('models/model_yml/yolo-v4-tiny-tf_openvino_2021.4_6shave.blob')).resolve().absolute())
nnPathDefault = str((Path(__file__).parent / Path('models/mobilenet-ssd_openvino_2021.4_8shave.blob')).resolve().absolute())
